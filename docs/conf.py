...
"""
openedx_course_export documentation build configuration file.
...
#
# html_title = 'openedx_course_export v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A django app plugin to add a new API to Open edX to export courses to S3 buckets',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_course_export'),
                os.path.join(root_path, 'openedx_course_export/migrations')])
